<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="Area.aspx.cs" Inherits="Krappsena.Area" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
      <h1>
        Administrar Registro de Area
        <small>Crear, Modificar y Eliminar Registro de Area</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="Default.aspx"><i class="fa fa-th"></i> Inicio</a></li>
           <li><a href="Area.aspx"><i class="fa fa-users"></i> Registro de Area</a></li>
      </ol>
    </section>
              ...
              <div class="modal-body">
                  ...
                  <div class="row">
                      <div class="form-group col-md-3">
                          <label for="id area">Id area</label>
                          <input type="text"name="id area"id="id" class="form-control" placeholder="*****"/>
                      </div>
