<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="Categorias.aspx.cs" Inherits="Krappsena.Categorias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>Crear, Modificar y Eliminar Categorias</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="Default.aspx"><i class="fa fa-th"></i> Inicio</a></li>
           <li><a href="Categorias.aspx"><i class="fa fa-users"></i> Categorias</a></li>
      </ol>
    </section>
              ...
              <div class="modal-body">
                  ...
                  <div class="row">
                      <div class="form-group col-md-3">
                          ...
                          <input type="text"name="id categorias"id="ID Categorias" class="form-control" placeholder="12345..."/>
                      </div>
