<%@ Page Title="" Language="C#" MasterPageFile="~/site.Master" AutoEventWireup="true" CodeBehind="Cargo.aspx.cs" Inherits="Krappsena.Cargo" %>
...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Administrar Cargo
        <small>Crear, Modificar y Eliminar Cargo</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="Default.aspx"><i class="fa fa-th"></i> Inicio</a></li>
           <li><a href="Cargo.aspx"><i class="fa fa-users"></i> Cargo</a></li>
      </ol>
    </section>
              ...
              <div class="modal-body">
                  ...
                  <div class="row">
                      <div class="form-group col-md-3">
                          ...
                          <input type="text"name="id"id="id" class="form-control" placeholder="12345..."/>
                      </div>
